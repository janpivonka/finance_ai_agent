...
export const HistoryEmptyState: React.FC<HistoryEmptyStateProps> = ({ searchQuery }) => {
  ...
  return (
    <motion.div 
      ...
      className="text-center py-20 px-6 bg-[var(--panel)] backdrop-blur-xl rounded-[3rem] border-2 border-dashed border-[color:var(--panel-border)] flex flex-col items-center relative z-10"
    >
