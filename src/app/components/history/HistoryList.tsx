  ...
  <div className="flex flex-col gap-6 relative z-10">
    ...
    <div className="flex flex-col gap-4">
      {items.map((item, index) => {
        console.log(`Rendering item ${index}: ${item.id} - ${item.fileName}`);
        return (
          <HistoryItem
            key={item.id}
            item={item}
