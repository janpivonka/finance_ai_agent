...
export const LoadingOverlay: React.FC<LoadingOverlayProps> = ({ 
  ...
  const variants = {
    fuchsia: "bg-fuchsia-500/10 ring-fuchsia-500/20 border-fuchsia-500/30 text-fuchsia-400",
    indigo: "bg-indigo-500/10 ring-indigo-500/20 border-indigo-500/30 text-indigo-400",
    cyan: "bg-cyan-500/10 ring-cyan-500/20 border-cyan-500/30 text-cyan-400",
  };

  return (
    <div className={`fixed inset-0 z-[200] flex items-center justify-center bg-[#020617]/85 backdrop-blur-md ${className}`}>
      <div className={`mx-6 w-full max-w-md rounded-[2.5rem] border p-10 shadow-2xl ring-1 bg-slate-900/40 backdrop-blur-xl ${variants[variant]}`}>
