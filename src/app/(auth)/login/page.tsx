      ...
      >
        <div className="bg-[var(--panel)] backdrop-blur-2xl border border-[color:var(--panel-border)] rounded-[3rem] p-8 md:p-12 shadow-[0_40px_100px_rgba(0,0,0,0.5)] ring-1 ring-white/5">
          ...
          <div className="flex flex-col items-center mb-10 text-center">
            <div className="w-16 h-16 bg-gradient-to-br from-indigo-600 to-cyan-400 rounded-2xl flex items-center justify-center shadow-2xl shadow-indigo-500/20 mb-6 group hover:rotate-12 transition-transform duration-500">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <button 
              type="submit"
              className="group relative w-full py-4 bg-indigo-600 hover:bg-indigo-500 text-white rounded-2xl font-black text-sm uppercase tracking-widest transition-all hover:scale-[1.02] hover:shadow-[0_20px_40px_rgba(79,70,229,0.3)] cursor-pointer mt-4 overflow-hidden"
            >
          ...
          <p className="mt-10 text-center text-slate-500 text-sm font-medium">
            ...
            <button 
              ...
              className="text-cyan-400 hover:text-white font-black transition-colors cursor-pointer"
            >
              Zaregistrujte se
            </button>
          </p>
